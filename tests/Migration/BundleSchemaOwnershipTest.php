...
final class BundleSchemaOwnershipTest extends TestCase
{
    ...
    {
        // 14 translation/ownership lookups plus the two language URL mapping
        // lookups the frontend resolves on every request of a configured site.
        // Content translations carry no review column, so they contribute a
        // pid/language lookup and no review lookup.
        self::assertCount(16, BundleSchema::INTEGRITY_INDEXES);
        self::assertCount(16, array_unique(array_map(
